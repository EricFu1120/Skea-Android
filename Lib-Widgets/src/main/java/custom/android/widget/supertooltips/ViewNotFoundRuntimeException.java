...
/**
 * A {@link RuntimeException} that is thrown if there is no
 * {@link android.view.View} found with given resource id. You can choose to
 * ignore this by catching the ViewNotFoundRuntimeException.
 */

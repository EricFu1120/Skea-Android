...
import static cn.ervin.bluetooth.EasyBluetoothConst.ConnectState.STATE_LISTEN;
import static cn.ervin.bluetooth.EasyBluetoothConst.ConnectState.STATE_NONE;

public class EasyBluetoothService {
    // Debugging
    private static final String TAG = "EasyBluetoothService";
    ...
    public synchronized void connected(BluetoothSocket socket, BluetoothDevice
        ...
        bundle.putString(EasyBluetoothConst.DEVICE_NAME, device.getName());
        bundle.putString(EasyBluetoothConst.DEVICE_ADDRESS, device.getAddress());
        msg.setData(bundle);
    ...
    private class AcceptThread extends Thread {
        ...
        public AcceptThread() {
            ...
            try {
                if (EasyBluetoothConfig.IS_ANDROID)
        ...
        public void run() {
            ...
            while (mState != STATE_CONNECTED && isRunning) {
                ...
                if (socket != null) {
                    synchronized (EasyBluetoothService.this) {
                        switch (mState) {
                            case STATE_LISTEN:

...
//import me.linkcube.app.core.bluetooth.BluetoothConst.TOY_TYPE;
...
//import static me.linkcube.app.core.bluetooth.BluetoothConst.DEVICE_DEFAULT_NAMES;

import linkcube.skea.bluetooth.BluetoothConst;
...
public class BluetoothUtils {
	...
	public static List<BluetoothDevice> getBondedDevices() {
		...
		for (BluetoothDevice device : pairedDevices) {
			for (int nc = 0; nc < linkcube.skea.bluetooth.BluetoothConst.DEVICE_DEFAULT_NAMES.length; nc++) {
				if (device.getName().equalsIgnoreCase(linkcube.skea.bluetooth.BluetoothConst.DEVICE_DEFAULT_NAMES[nc])) {
					devlist.add(device);
					break;
				}
			}
	...
	public static linkcube.skea.bluetooth.BluetoothConst.TOY_TYPE getDeviceType(String name) {
		if (name.equals(linkcube.skea.bluetooth.BluetoothConst.DEVICE_DEFAULT_NAMES[0])) {
			return linkcube.skea.bluetooth.BluetoothConst.TOY_TYPE.MARS;
		} else {
			return linkcube.skea.bluetooth.BluetoothConst.TOY_TYPE.VENUS;
		}
	}

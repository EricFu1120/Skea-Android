...
public class ReEvaluateActivity extends BaseActivity implements TwoWayRadioGroup.OnTwoWaySelectedListener, LevelRadioGroup.OnLevelSelectedListener, NumberPickerDialog.OnValueChangedListener, View.OnClickListener {
    ...
    public int getLayoutResourceId() {
        return R.layout.activity_reevaluate;
    }
        ...
        switch (v.getId()) {
            case R.id.birthday_tv:
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(
                        ReEvaluateActivity.this, myDateSetListener, mYear, mMonth,
                        mDays);
